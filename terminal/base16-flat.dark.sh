...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#151515', '#E74C3C', '#2ECC71', '#F1C40F', '#3498DB', '#9B59B6', '#1ABC9C', '#e0e0e0', '#95A5A6', '#E74C3C', '#2ECC71', '#F1C40F', '#3498DB', '#9B59B6', '#1ABC9C', '#ECF0F1']"
...
gset string palette "#151515:#E74C3C:#2ECC71:#F1C40F:#3498DB:#9B59B6:#1ABC9C:#e0e0e0:#95A5A6:#E74C3C:#2ECC71:#F1C40F:#3498DB:#9B59B6:#1ABC9C:#ECF0F1"
